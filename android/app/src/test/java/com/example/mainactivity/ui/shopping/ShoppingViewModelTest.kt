...
class ShoppingViewModelTest {
    ...
    @Test
    fun `lists are empty before userId emits`() =
    ...
    @Test
    fun `null userId clears lists and itemCounts`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `addList adds entry optimistically to lists`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `addList preserves specified icon`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `addList with null userId does not add entry`() =
        runTest(dispatcherRule.dispatcher) {
    ...
    @Test
    fun `multiple addList calls accumulate entries`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `deleteList removes entry optimistically from lists`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `deleteList only removes the target list`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `addItem adds entry optimistically to items`() =
        runTest(dispatcherRule.dispatcher) {
    ...
    @Test
    fun `addItem sets correct listId and defaults checked to false`() =
        runTest(dispatcherRule.dispatcher) {
    ...
    @Test
    fun `toggle marks unchecked item as checked`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            advanceUntilIdle()
    ...
    @Test
    fun `toggle marks checked item as unchecked`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            advanceUntilIdle()
    ...
    @Test
    fun `toggle only affects the target item`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            ...
            assertTrue(
                "Milk should be checked",
                vm.items.value
                    .first { it.item == "Milk" }
                    .checked,
            )
            assertFalse(
                "Bread should remain unchecked",
                vm.items.value
                    .first { it.item == "Bread" }
                    .checked,
            )
    ...
    @Test
    fun `deleteItem removes item optimistically`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            advanceUntilIdle()
    ...
    @Test
    fun `deleteItem only removes target item`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            vm.addItem("list-1", "Bread")
            advanceUntilIdle()
    ...
    @Test
    fun `clearCompleted removes checked items and leaves unchecked`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            vm.addItem("list-1", "Butter")
            advanceUntilIdle()
    ...
    @Test
    fun `clearCompleted with no checked items leaves all items`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            vm.addItem("list-1", "Bread")
            advanceUntilIdle()
    ...
    @Test
    fun `clearCompleted on empty list is a no-op`() =
        runTest(dispatcherRule.dispatcher) {
            vm.clearCompleted("list-1")
            advanceUntilIdle()
    ...
    @Test
    fun `familyChanged triggers getUser call when userId is set`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `familyChanged without userId is a no-op`() =
        runTest(dispatcherRule.dispatcher) {
    ...
    @Test
    fun `changeListIcon updates icon optimistically in lists`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
    ...
    @Test
    fun `renameItem updates item text optimistically`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            advanceUntilIdle()
    ...
    @Test
    fun `renameItem preserves checked state`() =
        runTest(dispatcherRule.dispatcher) {
            vm.addItem("list-1", "Milk")
            advanceUntilIdle()
    ...
    @Test
    fun `emitting same userId twice does not double getUser on second emit`() =
        runTest(dispatcherRule.dispatcher) {
            userId.value = "user1"
            advanceUntilIdle()
