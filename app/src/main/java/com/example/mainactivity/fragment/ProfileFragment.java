...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView userID = view.findViewById(R.id.ProfileBrukerId);
        TextView mobilnr = view.findViewById(R.id.ProfileMobilNummer);
        TextView fodselsdato = view.findViewById(R.id.ProfileFodselsdato);
        TextView email = view.findViewById(R.id.email);
        TextView navn = view.findViewById(R.id.navn);
        ImageView photo = view.findViewById(R.id.profilebilde);
        ...
        // Endre profile
        Button endreProfileBtn = view.findViewById(R.id.btnEndreProfile);
        endreProfileBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                navController.navigate(R.id.profileEditFragment, bundle);
            }
        });
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Jat",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                editor.clear();
                                editor.apply();
                                Log.i("ProfileFragment","Brukeren logget ut");
                ...
                builder.setNegativeButton("Nei",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int id) {
                                Log.i("ProfileFragment", "Brukeren ble ikke logget ut");
                                dialog.cancel();
                            }
                        });
