...
public class WishlistAddFragment extends Fragment {
    public WishlistAddFragment() {}

    SharedPreferences sharedPreferences;
    Database database;

    private NavController navController;
    private Button lagList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lagList = view.findViewById(R.id.lagWishlist);
        wishlistName = view.findViewById(R.id.wishlistName);

        lagList.setOnClickListener(new View.OnClickListener() {
            @Override
