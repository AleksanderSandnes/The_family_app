...
public class BirthdayAddFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_birthday_add, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lagre = view.findViewById(R.id.NyBirthdayLagre);
        ...
        lagre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() == 0) {
                    ...
                    Log.e("BirthdayAddFragment", "Navn er ikke fylt inn korrekt");
                } else {
                    // NAVN OK
                    Log.i("BirthdayAddFragment", "Navn er fylt inn korrekt: " + name + ". Dato: " + date);
