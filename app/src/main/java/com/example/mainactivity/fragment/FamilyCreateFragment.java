...
public class FamilyCreateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_family_create, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        navn = view.findViewById(R.id.CreateFamilyCreateNavn);
        passord = view.findViewById(R.id.CreateFamilyCreatePassord);
        passordIgjen = view.findViewById(R.id.CreateFamilyGjentaPassord);
        opprettFamily = view.findViewById(R.id.CreateFamilyBtn);

        name = getArguments().getString("NAVN");
        date = getArguments().getString("DATO");

        opprettFamily.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (passord.getText().toString().equals(passordIgjen.getText().toString())) {
                    ...
                    Log.i("FamilyCreateFragment", "Data successfully inserted");
